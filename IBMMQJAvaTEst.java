...
public class IBMMQJAvaTEst {
    public static void main(String[] args) {
        String input = "414D51204F41504C483030504950202HKID20241024144956430433";
        ...
        try {
            ...
            String finalHex = hexString.toString().substring(0, 48);

            // Step 4: Output the result
            System.out.println("Hexa5decimal hash: " + finalHex);
